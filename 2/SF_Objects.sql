...
snowflake.execute({sqlText: `
    ...
    T."CAST" = S."CAST",
    T."COUNTRY" = S."COUNTRY",
    T."DATE_ADDED" = TRY_TO_DATE(S."DATE_ADDED", 'MMMM DD, YYYY'),
    ...
    VALUES
    (S."SHOW_ID", S."TYPE", S."TITLE", S."DIRECTOR", S."CAST", S."COUNTRY", TRY_TO_DATE(S."DATE_ADDED", 'MMMM DD, YYYY'), S."RELEASE_YEAR", S."RATING", S."DURATION", S."LISTED_IN", S."DESCRIPTION");
    `});
    $$;
